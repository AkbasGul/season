...
if (
  ...
  console.log(`The seanson for ${month}/${day} is Winter.`);
} else if (
  (month === 2 && day >= 21) ||
  (month >= 2 && month <= 5 && day <= 31)
) {
  console.log(`The seanson for ${month}/${day} is Spring.`);
} else if (
  (month === 6 && day >= 1) ||
  (month >= 6 && month <= 9) ||
  (month === 9 && day <= 21)
) {
  console.log(`The seanson for ${month}/${day} is Summer.`);
} else if (
  (month === 9 && day >= 22) ||
  (month >= 9 && month <= 12 && day <= 20) ||
  (month === 12 && day <= 20)
)
  console.log(`The seanson for ${month}/${day} is Fall.`);
